...
| [`04-grace-and-lock-reclaim-design.md`](04-grace-and-lock-reclaim-design.md) | 4 | CHAOS-05, CHAOS-06 (whole-file locks), CHAOS-07, OBS-02, OBS-03 | Shipped |
| [`05-data-path-and-locktool-design.md`](05-data-path-and-locktool-design.md) | 6 | DATA-06 to DATA-13, the byte-range half of DATA-05 and the disjoint-range half of CHAOS-06, plus `locktool` | Shipped, DATA-14 deferred |
