...
documents drifted the first time. It is unnumbered because it is not part of the
record the numbered documents keep, and it goes away when the last step lands.

- What gets verified: [`01-test-plan.md`](01-test-plan.md).
- How the harness works, and every flag: the repository
  [`README.md`](../README.md).
- Why a phase is built the way it is: that phase's design doc, [`00-index.md`](00-index.md).
...
| 6 | Close out DATA: DATA-06 to DATA-13, `locktool`. [Design](05-data-path-and-locktool-design.md) | done except the soak, [PR #12](https://github.com/mikebz/nfs-verification/pull/12) onward. DATA-10 has not been run; DATA-14 is deferred (test plan Section 3.2) |
