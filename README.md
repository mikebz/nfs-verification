...
| [`08-test-audit-server-vs-local.md`](docs/08-test-audit-server-vs-local.md) | Audit, not a delivery group: where a local check stands behind a claim about the server, and what to do about it |
